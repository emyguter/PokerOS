...
// à parte (Acertos → Taxa App). Pode vincular em qualquer nível da hierarquia
// — Mega Liga, SuperLiga, Liga, Clube, Agente/Super Agente ou Jogador
// (pedido do Cássio: "considerar todas as possibilidades... o céu deve ser
// o limite"); o valor soma o Rake Total de todo o escopo daquela entidade no
// período (clubes pra Mega Liga/SuperLiga/Liga/Clube; próprio agente/jogador
// pros outros dois) e avalia a faixa SE/ENTÃO em cima da soma — ver
// lib/taxa-app.ts.
...
export type StoplossHistoricoTipo = 'inicial' | 'antecipacao' | 'ajuste_suporte' | 'caucao' | 'margem_monitoria' | 'bug_ppp' | 'corte_50'
