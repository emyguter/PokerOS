export const pt = {
  ...
  stoploss: {
    ...
    corte_50_confirmar: 'Cortar o Stoploss Atual desse clube pela metade agora? Essa ação é permanente (não some sozinha, precisa de um Ajuste pra reverter).',
    corte_50_aplicado: 'Stoploss cortado pela metade.',
    corte_50_ativo: 'Corte 50% ativo (Acerto pendente) — o valor cortado continua permanente, isso aqui só reverte o status.',
