...
export const en: typeof pt = {
  ...
  stoploss: {
    ...
    corte_50_confirmar: "Cut this club's current Stoploss in half now? This is permanent (doesn't clear on its own, needs an Adjustment to reverse).",
    corte_50_aplicado: 'Stoploss cut in half.',
    corte_50_ativo: 'Corte 50% active (pending settlement) — the cut amount stays permanent, this only reverts the status.',
