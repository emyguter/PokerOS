...
const EMPTY: SuperLeagueForm = { name: '', moeda: 'BRL', plataforma_id: null, mega_liga_id: null }
...
export default function SuperLigasPage() {
  ...
  const load = useCallback(async () => {
    setLoading(true)
    try { setItems(await getSuperLeagues()) }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-white">Superligas</h1>
          <p className="text-sm text-gray-400 mt-1">Entidade raiz — agrupa múltiplas ligas</p>
        </div>
